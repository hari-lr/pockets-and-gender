...
# Clean json file (pocket area measurments)
...
# save json cleaned data 

# Change from json format to csv
csv_file <- here::here("data/analysis_data/cleaned_json_data.csv")

# Write the cleaned data frame to a CSV file
write_csv(cleaned_json_data, csv_file)
